...
SECRET_KEY = 'django-insecure-sb9d354^gk$7jun8vike)3q^*y3c*_s21&qq9s4#-8x+rl^@#b'
...
# Email settings - Development only (prints to console)
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
DEFAULT_FROM_EMAIL = 'noreply@example.com'  # Can be any email for development
